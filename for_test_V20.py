...
gpu=[0]
dictionaries=['./Github/2022-1-OSSP2-DoJungJongKwang-2/dictionary.txt']
hidden_size = 256
batch_size_t = 1
maxlen = 100
...
def for_test(x_t):
  ...
  encoder.load_state_dict(torch.load('./Github/2022-1-OSSP2-DoJungJongKwang-2/model/encoder_lr0.00001_GN_te1_d05_SGD_bs6_mask_conv_bn_b_xavier.pkl'))
  attn_decoder1.load_state_dict(torch.load('./Github/2022-1-OSSP2-DoJungJongKwang-2/model/attn_decoder_lr0.00001_GN_te1_d05_SGD_bs6_mask_conv_bn_b_xavier.pkl'))
